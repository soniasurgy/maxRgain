...
- **stats** and **utils**: base R packages used for common statistical and utility functions.

## Example

In this example, we wish to improve yields by at least 20%, and the potential alcohol and total acidity by at least 3%. We wish to obtain group sizes between 7 and 12 genotypes.
